    ...
    public:
        ...
        void OnEvent(const IEvent& event) override {
            if (event.GetType() == "Collision") {
                const EventCollision& collision = static_cast<const EventCollision&>(event);
...
class Subject : public ISubject {
    public:
        ...
        int GenerateObserverID() {
            return ++observer_id_counter_;
        }
...
class Observer : public IObserver {
    public:
        Observer(Subject &subject) : subject_(subject), number_(subject.GenerateObserverID()) {
