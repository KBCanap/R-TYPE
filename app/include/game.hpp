...
class Game {
  public:
     ...
     * @param netMgr Optional network manager for multiplayer mode (nullptr for
     * solo)
     */
  ...
  private:
    ...
    std::unique_ptr<NetworkCommandHandler>
        _networkCommandHandler;        ///< Network command processor
