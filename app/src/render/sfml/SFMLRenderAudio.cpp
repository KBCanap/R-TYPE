...
AudioStatus SFMLSound::fromSFMLStatus(sf::Sound::Status status) const {
    switch (status) {
        case sf::Sound::Stopped: return AudioStatus::Stopped;
        case sf::Sound::Paused: return AudioStatus::Paused;
        case sf::Sound::Playing: return AudioStatus::Playing;
...
AudioStatus SFMLMusic::fromSFMLStatus(sf::Music::Status status) const {
    switch (status) {
        case sf::Music::Stopped: return AudioStatus::Stopped;
        case sf::Music::Paused: return AudioStatus::Paused;
        case sf::Music::Playing: return AudioStatus::Playing;
        default: return AudioStatus::Stopped;
    }
}

// SFMLRenderAudio implementation
ISound* SFMLRenderAudio::createSound() {
    return new SFMLSound();
}
...
IMusic* SFMLRenderAudio::createMusic() {
    return new SFMLMusic();
}
...
float SFMLRenderAudio::getGlobalVolume() const {
