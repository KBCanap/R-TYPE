...
std::unique_ptr<IShape> SFMLRenderWindow::createRectangleShape(const Vector2f& size) {
...
void SFMLView::reset(const FloatRect& rectangle) {
    _view.reset(sf::FloatRect(rectangle.left, rectangle.top, rectangle.width, rectangle.height));
}
...
sf::Keyboard::Key SFMLRenderWindow::toSFMLKey(Key key) {
    ...
    static const std::unordered_map<Key, sf::Keyboard::Key> keyMap = {
        ...
        {Key::A, sf::Keyboard::A}, {Key::B, sf::Keyboard::B}, {Key::C, sf::Keyboard::C},
        {Key::D, sf::Keyboard::D}, {Key::E, sf::Keyboard::E}, {Key::F, sf::Keyboard::F},
        {Key::G, sf::Keyboard::G}, {Key::H, sf::Keyboard::H}, {Key::I, sf::Keyboard::I},
        {Key::J, sf::Keyboard::J}, {Key::K, sf::Keyboard::K}, {Key::L, sf::Keyboard::L},
        {Key::M, sf::Keyboard::M}, {Key::N, sf::Keyboard::N}, {Key::O, sf::Keyboard::O},
        {Key::P, sf::Keyboard::P}, {Key::Q, sf::Keyboard::Q}, {Key::R, sf::Keyboard::R},
        {Key::S, sf::Keyboard::S}, {Key::T, sf::Keyboard::T}, {Key::U, sf::Keyboard::U},
        {Key::V, sf::Keyboard::V}, {Key::W, sf::Keyboard::W}, {Key::X, sf::Keyboard::X},
        ...
        {Key::Escape, sf::Keyboard::Escape}, {Key::LControl, sf::Keyboard::LControl},
        {Key::LShift, sf::Keyboard::LShift}, {Key::LAlt, sf::Keyboard::LAlt},
        {Key::LSystem, sf::Keyboard::LSystem}, {Key::RControl, sf::Keyboard::RControl},
        {Key::RShift, sf::Keyboard::RShift}, {Key::RAlt, sf::Keyboard::RAlt},
        {Key::RSystem, sf::Keyboard::RSystem}, {Key::Menu, sf::Keyboard::Menu},
        {Key::LBracket, sf::Keyboard::LBracket}, {Key::RBracket, sf::Keyboard::RBracket},
        {Key::Semicolon, sf::Keyboard::Semicolon}, {Key::Comma, sf::Keyboard::Comma},
        {Key::Period, sf::Keyboard::Period}, {Key::Quote, sf::Keyboard::Quote},
        {Key::Slash, sf::Keyboard::Slash}, {Key::Backslash, sf::Keyboard::Backslash},
        {Key::Tilde, sf::Keyboard::Tilde}, {Key::Equal, sf::Keyboard::Equal},
        {Key::Hyphen, sf::Keyboard::Hyphen}, {Key::Space, sf::Keyboard::Space},
        {Key::Enter, sf::Keyboard::Enter}, {Key::Backspace, sf::Keyboard::Backspace},
        {Key::Tab, sf::Keyboard::Tab}, {Key::PageUp, sf::Keyboard::PageUp},
        {Key::PageDown, sf::Keyboard::PageDown}, {Key::End, sf::Keyboard::End},
        {Key::Home, sf::Keyboard::Home}, {Key::Insert, sf::Keyboard::Insert},
        {Key::Delete, sf::Keyboard::Delete}, {Key::Add, sf::Keyboard::Add},
        {Key::Subtract, sf::Keyboard::Subtract}, {Key::Multiply, sf::Keyboard::Multiply},
        {Key::Divide, sf::Keyboard::Divide}, {Key::Left, sf::Keyboard::Left},
        {Key::Right, sf::Keyboard::Right}, {Key::Up, sf::Keyboard::Up},
        {Key::Down, sf::Keyboard::Down}, {Key::Numpad0, sf::Keyboard::Numpad0},
        {Key::Numpad1, sf::Keyboard::Numpad1}, {Key::Numpad2, sf::Keyboard::Numpad2},
        {Key::Numpad3, sf::Keyboard::Numpad3}, {Key::Numpad4, sf::Keyboard::Numpad4},
        {Key::Numpad5, sf::Keyboard::Numpad5}, {Key::Numpad6, sf::Keyboard::Numpad6},
        {Key::Numpad7, sf::Keyboard::Numpad7}, {Key::Numpad8, sf::Keyboard::Numpad8},
        {Key::Numpad9, sf::Keyboard::Numpad9}, {Key::F1, sf::Keyboard::F1},
        {Key::F2, sf::Keyboard::F2}, {Key::F3, sf::Keyboard::F3}, {Key::F4, sf::Keyboard::F4},
        {Key::F5, sf::Keyboard::F5}, {Key::F6, sf::Keyboard::F6}, {Key::F7, sf::Keyboard::F7},
        {Key::F8, sf::Keyboard::F8}, {Key::F9, sf::Keyboard::F9}, {Key::F10, sf::Keyboard::F10},
...
sf::Mouse::Button SFMLRenderWindow::toSFMLMouse(Mouse button) {
    switch (button) {
        case Mouse::Left: return sf::Mouse::Left;
        case Mouse::Right: return sf::Mouse::Right;
        case Mouse::Middle: return sf::Mouse::Middle;
        case Mouse::XButton1: return sf::Mouse::XButton1;
        case Mouse::XButton2: return sf::Mouse::XButton2;
