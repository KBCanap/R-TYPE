...
entity EnemyManager::spawnEnemy() {
    ...
    if (weapon_type == 2) { // Spread enemy - use different spritesheet
        _registry.add_component<component::drawable>(enemy, component::drawable("assets/sprites/r-typesheet3.gif", render::IntRect(), 3.0f, "enemy_spread"));
    } else { // Single/Burst enemies - use original spritesheet
        _registry.add_component<component::drawable>(enemy, component::drawable("assets/sprites/r-typesheet9.gif", render::IntRect(), 1.0f, "enemy"));
    }
...
component::weapon EnemyManager::createEnemySingleWeapon() {
    return component::weapon(1.0f, false, 1, 0.0f,
        ...
        false, 3, 0.1f, render::IntRect(249, 103, 16, 12));
}
...
component::weapon EnemyManager::createEnemyBurstWeapon() {
    return component::weapon(1.5f, false, 1, 0.0f,
        ...
        true, 4, 0.15f, render::IntRect(249, 103, 16, 12));
}
