 ...
 * 
 * This interface defines the contract that all UDP server implementations must follow.
 * Unlike TCP, UDP is connectionless, so client management is based on endpoints.
 */
class IUdpServer {
    public:
