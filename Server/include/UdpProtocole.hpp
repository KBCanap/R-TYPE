...
public:
    ...
    std::string createPlayerAssignment(uint32_t player_net_id, uint32_t sequence_num);
    std::string createEntityCreate(const Entity& entity, uint32_t sequence_num);
    std::string createEntityUpdate(const std::vector<Entity>& entities, uint32_t sequence_num);
    std::string createEntityDestroy(const std::vector<uint32_t>& net_ids, uint32_t sequence_num);
    std::string createGameState(const std::vector<Entity>& entities, uint32_t sequence_num);
...
private:
    ...
    std::string createMessage(UdpMessageType type, uint32_t sequence_num, const std::vector<uint8_t>& data);
